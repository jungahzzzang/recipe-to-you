...
<body>
	...
	<form action="">
		...
		<table id="userTable">
			<tr>
				<td class="grayBg">결제코드</td>
				<td class="whiteBg">${paymentVO.pay_code}</td>
				<td class="grayBg">결제수단</td>
				<td class="whiteBg">${paymentVO.pay_method}</td>
			</tr>
			<tr>
				<td class="grayBg">결제일</td>
				<td class="whiteBg">${paymentVO.pay_date}</td>
				<td class="grayBg">결제금액</td>
				<td class="whiteBg">${paymentVO.pay_price}</td>
			</tr>
		</table>
		</div>
