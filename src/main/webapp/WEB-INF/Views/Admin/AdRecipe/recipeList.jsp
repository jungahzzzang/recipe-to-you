...
<head>
	...
	<script type="text/javascript" src="/recipetoyou/Resources/Admin/Js/AdUser/adRecipeList.js" charset="UTF-8"></script>
		...
		<table align="center" id="tableGroup">
			<thead>
				<tr align="center" class="table_title">
					...
					<td id="ordCol">레시피번호</td>
					<td id="nameCol">상품코드</td>
					<td id="phoneCol">레시피제목</td>
		...
		<tbody class="table_content">
			<c:forEach var="recipe" items="${recipeList }">
				<tr align="center">
					...
					<td>${recipe.recipe_idx }</td>
					<td>${recipe.prod_code }</td>
			...
			<div class="text-center">
				<ul class="pagination">
					...
					<c:forEach var="idx" begin="${pm.startPage}" end="${pm.endPage}">
						...
						<li ${pm.vo.pmake == idx? 'class=active':''}>
						 	<a href="${idx}">${idx}</a>
						</li>				
					</c:forEach>
				 			<!-- 다음next -->
