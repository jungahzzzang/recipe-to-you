...
<body>
	...
	<div class="title">
	<c:out value="${aduserDrawVO.user_name}"/>님의 회원 정보입니다.
	</div>
	...
	<form action="">
		...
		<table id="userTable">
			<tr>
				...
				<td class="whiteBg">${aduserDrawVO.user_name}</td>
				<td class="grayBg">추천인아이디</td>
				<td class="whiteBg">${aduserDrawVO.recommendId}</td>
			</tr>
			<tr>
				<td class="grayBg">아이디</td>
				<td class="whiteBg">${aduserDrawVO.user_id}</td>
				<td class="grayBg">생일</td>
				<td class="whiteBg">${aduserDrawVO.user_birth}</td>
			</tr>
			<tr>
				<td class="grayBg">성별</td>
				<td class="whiteBg">${aduserDrawVO.user_gender}</td>
				<td class="grayBg">가입일시</td>
				<td class="whiteBg">${aduserDrawVO.join_date}</td>
			</tr>
			<tr>
				<td class="grayBg">회원등급</td>
				<td class="whiteBg"><b>${aduserDrawVO.user_grade}</b></td>
				...
				<td class="whiteBG">${aduserDrawVO.user_pw}</td>
			</tr>
			<tr>
				<td class="grayBg">휴대전화</td>
				<td class="whiteBg">${aduserDrawVO.user_phone}</td>
				<td class="grayBg">이메일</td>
				<td class="whiteBg">${aduserDrawVO.user_email}</td>
			</tr>
			<tr>
				<td class="grayBg">주소</td>
				<td class="whiteBg" colspan="3">${aduserDrawVO.user_addr}</td>
			</tr>
			<tr>
				<td class="grayBg">적립금</td>
				<td class="whiteBg">${aduserDrawVO.user_point}</td>
				<td class="grayBg">쿠폰</td>
				<td class="whiteBg">${aduserDrawVO.cp_code}</td>
			</tr>
			<tr>
				<td class="grayBg">뉴스레터 수신</td>
				<td class="whiteBg">${aduserDrawVO.email_agree}</td>
				<td class="grayBg">문자메시지 수신</td>
				<td class="whiteBg">${aduserDrawVO.sms_agree}</td>
			</tr>
			<tr>
				<td class="grayBg">개인정보수신동의</td>
				<td class="whiteBg">${aduserDrawVO.info_agree}</td>
				<td class="grayBg">투유패쓰</td>
				<td class="whiteBg">${aduserDrawVO.toYou_pass}</td>
			</tr>
			<tr colspan="2">
				<td class="grayBg">참여이벤트명</td>
				<td class="whiteBg">${aduserDrawVO.join_event}</td>
			</tr>
		...
		<button type="button" class="backBtn" onclick="location.href='${contextPath}/aduserWithdraw/listadUsersWithdraw.do'">뒤로가기</button>
	</form>
	</div>
</body>
</html>