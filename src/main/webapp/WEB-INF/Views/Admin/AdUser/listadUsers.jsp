		...
		<tbody class="table_content">
			<c:forEach var="user" items="${userList }">
				<tr align="center">
					...
					<td><button type="button"><a href="${contextPath}/aduser/moduserInfo.do?id=${user.user_id}">수정</a></button></td>
					<td><button onclick="deleteMessage()"><a href="${contextPath}/aduser/removeUser.do?id=${user.user_id}">삭제</a></button></td>
				</tr>
			</c:forEach>
		</tbody>	
		</table>
