...
public class CategoryVO {
	...
	public CategoryVO(int prod_code, String prod_name, String prod_content, int prod_price,
	...
	public String toString() {
		return "CategoryVO [prod_code=" + prod_code + ", cateCode=" + cateCode + ", prod_name=" + prod_name
